...
public class MyBatisTestApp09 {
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println(":: 1. addUser(INSERT)  ? "
													+ session.insert("UserMapper09.addUser",user)); //1
													  session.commit();
		//2. User10.getUser Test :: 주몽 inert 확인 
		System.out.println(":: 2. getUser(SELECT)  ? ");
		System.out.println(" :: "+session.selectOne("UserMapper09.getUser",user.getUserId()) );
